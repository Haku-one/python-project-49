<?php
/**
 * СДЭК Интеграция для WooCommerce - Обновленная версия
 * Добавление в блок "Параметры доставки"
 */
        ...
        public function init_form_fields() {
            $this->form_fields = array(
                ...
                'from_city_code' => array(
                    ...
                    'type' => 'text',
                    'description' => 'Код города СДЭК откуда отправляем (по умолчанию Саратов - 194)',
                    'default' => '194'
                )
            );
        }
...
class CDEK_WooCommerce_Integration {
    ...
    public function calculate_shipping_cost($package) {
        ...
        $from_city_code = 194; // По умолчанию Саратов
        
        if (isset($shipping_methods['cdek_shipping'])) {
            $cdek_method = $shipping_methods['cdek_shipping'];
            $from_city_code = $cdek_method->get_from_city_code();
        }
...
// Хук для автоматического создания зоны доставки с методом СДЭК
